...
/**
 * The interface SubsystemsServiceV1
 */
@Component
public interface SubsystemsServiceV1 extends SubsystemsService {

    /**
     * Gets paginated list of subsystems based on limit and offset
     * @param offset Integer
     * @param limit Integer
     * @return list of subsystems
     */
    List<Subsystem> getAllSubsystemsPagination(Integer offset, Integer limit);
