...
class ConnectionPropertiesPositiveBase extends ContractsBase {

    def JSON_GETBYSUBID_CONNECTION_PROPS_CONTENT = "/connectionProperties/positive/GetConnectionPropsResponse.json"
    def JSON_GETBYID_CONNECTION_PROPS_CONTENT = "/connectionProperties/positive/GetConnectionPropsByIdResponse.json"
    def JSON_PATCH_CONNECTION_PROPS_CONTENT = "/connectionProperties/positive/PatchConnectionPropsByIdResponse.json"
    def JSON_POST_CONNECTION_PROPS_CONTENT = "/connectionProperties/positive/PostConnectionPropsResponse.json"
    def JSON_PUT_CONNECTION_PROPS_CONTENT = "/connectionProperties/positive/PutConnectionPropsByIdResponse.json"
    ...
    def setup () {
        ...
        RestAssuredMockMvc.standaloneSetup(connectionPropertiesController)
    }
}