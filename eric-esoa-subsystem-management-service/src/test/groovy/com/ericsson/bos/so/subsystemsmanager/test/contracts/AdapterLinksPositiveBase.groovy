...
class AdapterLinksPositiveBase extends ContractsBase {

    def JSON_ADAPTER_LINKS_CONTENT = "/adapterLinks/positive/GetAdapterLinks.json"
    ...
    def setup () {
        ...
        RestAssuredMockMvc.standaloneSetup(adapterLinksController)
    }
}