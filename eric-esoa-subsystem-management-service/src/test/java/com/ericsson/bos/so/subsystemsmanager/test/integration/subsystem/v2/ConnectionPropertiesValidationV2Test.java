...
/**
 * The Class ConnectionPropertiesValidationV2Test.
 */
public class ConnectionPropertiesValidationV2Test extends BaseIntegrationTest {
    ...
    private ResultActions postRequest(final Subsystem subsystem) throws Exception {
        return mockMvc.perform(post(ExpectedResponse.getServiceUrlV2() + "/subsystems")
