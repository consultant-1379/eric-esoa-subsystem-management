...
import com.ericsson.bos.so.subsystemsmanager.business.fieldfilter.v1.SubsystemFilterServiceV1Impl;
...
/**
 * The Class SubsystemFilterServiceImplTest.
 */
public class SubsystemFilterServiceImplTest {
    ...
    @Mock
    SubsystemsServiceV1 subsystemsServiceV1;
    ...
    @InjectMocks
    SubsystemFilterServiceV1Impl subsystemFilterServiceV1Impl;
    ...
    public void filterResponseFieldsTest() {
        ...
        when(subsystemsServiceV1.getAllSubsystems(Constants.TENANT_NAME)).thenReturn(listOfSubsystems);
        subsystemFilterServiceV1Impl.filterResponseFields(fields, Constants.TENANT_NAME);
    ...
    /**
     * Gets Subsystem by id as filter entity test.
     */
    @Test
    public void getByIdAsFilterEntityTest() {
        ...
        when(subsystemsServiceV1.getSubsystemById(subsystemId, Constants.TENANT_NAME)).thenReturn(createSubsystem());
        final SubsystemFilterEntity result = subsystemFilterServiceV1Impl.getByIdAsFilterEntity(subsystemId, Constants.TENANT_NAME);
        ...
        assertEquals(result.getSubsystemTypeId(), subsystem.getSubsystemTypeId());
        assertEquals(result.getUrl(), subsystem.getUrl());

    }

    /**
     * Gets all Subsystems as filter entities test.
     */
    @Test
    public void getAllAsFilterEntitiesTest() {
        ...
        final List<SubsystemFilterEntity> result = subsystemFilterServiceImpl.getAllAsFilterEntities(listOfSubsystems, false);
        ...
        assertEquals(result.get(0).getSubsystemTypeId(), listOfSubsystems.get(0).getSubsystemTypeId());
    ...
    public void filterResponseFieldsTestWithSubsystemIdAndTwoFields() {
        ...
        subsystemFilterServiceV1Impl.filterResponseSingleFieldFromKnownSubsystem(fields, subsystemId, Constants.TENANT_NAME);
        verify(subsystemExtractFieldsUtil, times(1)).extractSingleFieldFromSubsystemList(any(), any());
    }

    /**
     * Filter response fields test with subsystem id and one more field.
     */
    @Test
    public void filterResponseFieldsTestWithSubsystemIdAndOneField() {
        ...
        subsystemFilterServiceV1Impl.filterResponseSingleFieldFromKnownSubsystem(field, subsystemId, Constants.TENANT_NAME);
        verify(subsystemExtractFieldsUtil, times(1)).extractSingleFieldFromSubsystemList(any(), any());
    }
    ...
    public void filterResponseFieldsTestWithSubsystemIdAndTwoInvalidFields() throws JsonProcessingException {
        ...
        try {
            subsystemFilterServiceV1Impl.filterResponseSingleFieldFromKnownSubsystem(invalidFields, subsystemId, Constants.TENANT_NAME);
    ...
    public void filterResponseFieldsTestWithSubsystemIdAndOneInvalidField() {
        ...
        try {
            subsystemFilterServiceV1Impl.filterResponseSingleFieldFromKnownSubsystem(invalidField, subsystemId, Constants.TENANT_NAME);
        } catch (SubsystemsManagerException ex) {
            assertThat(ex.getInternalErrorCode(), is("SSM-C-06"));
        }
        verify(subsystemExtractFieldsUtil, times(1)).extractSingleFieldFromSubsystemList(any(), any());
    ...
    private Subsystem createSubsystem() {
        ...
        subsystemOne.setSubsystemTypeId(subsystemType.getId());
        return subsystemOne;
    }
