...
import static com.ericsson.bos.so.subsystemsmanager.web.controller.v1.AdapterLinksController.ADAPTERLINK_PATH;
...
/**
 * The Class AdapterLinkControllerTest.
 */
public class AdapterLinkControllerTest extends BaseIntegrationTest {
    ...
    /**
     * GIVEN subsystem type NFVO WHEN get request to adapter links returns NFVO adapter links.
     *
    ...
    /**
     * GIVEN no subsystem type param provided WHEN get request on adapter links THEN returns default NFVO adapterlinks.
     *
     * @throws Exception the exception
     */
    @Test
    public void GIVEN_noSubsystemTypeParamProvided_WHEN_getRequestOnAdapterLinks_THEN_defaultNFVOAdapterlinksReturned() throws Exception {
        ...
        //when
        final String getSubsystemsUri = pathProperties.getSubsystemManagement().getBasePath() + ADAPTERLINK_PATH;
    ...
    /**
     * GIVEN invalid subsystem type WHEN get request on adapter links THEN return subsystem type does not exist.
     *
     * @throws Exception the exception
     */
    @Test
    ...
    /**
     * GIVEN wrong access account WHEN get request on adapter links THEN return K8's API exception.
     *
     * @throws Exception the exception
     */
    @Test
    ...
    private ResultActions performMvcGETRequest(final String subsystemType) throws Exception {
        final String getSubsystemsUri = pathProperties.getSubsystemManagement().getBasePath() + ADAPTERLINK_PATH + "?type=" + subsystemType;
