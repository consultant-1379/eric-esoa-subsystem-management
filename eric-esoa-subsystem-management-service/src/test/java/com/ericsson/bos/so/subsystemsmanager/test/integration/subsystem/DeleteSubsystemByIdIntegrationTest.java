...
/**
 * The Class DeleteSubsystemByIdIntegrationTest.
 */
public class DeleteSubsystemByIdIntegrationTest extends BaseIntegrationTest {
    @Autowired
    ...
    public void GIVEN_subsystemInUse_WHEN_deleteSubsystem_THEN_errorResponse() throws Exception {
        ...
        response = mockMvc.perform(
                delete(ExpectedResponse.getServiceUrl() + Constants.$_SLASH + Constants.SUBSYSTEMS + Constants.$_SLASH + subsystem.getId().toString())
