...
/**
 * The Class SubsystemUserControllerTest.
 */
@WebMvcTest
public class SubsystemUserControllerTest extends MockMvcRequests {

    String subsystemUrl = ExpectedResponse.getSubsystemUrl();
    ...
    public void setUp() {
        ...
        mockMvc = MockMvcBuilders.standaloneSetup(daoControllerAdvice, subsystemUserController).build();
    }
    ...
    /**
     * Verift given delete request on subsystem user then expected JSON and status code returned.
     *
     * @throws Exception
     *             the exception
     */
    ...
    /**
     * Verify given not exist subsystem user id when delete request on subsystem user then subsystem user does not exist exception is thrown.
     *
     * @throws Exception
     *             the exception
     */
