...
Contract.make {
    description(
        """
            ```
            when:
                A client makes a request to create a connection properties for a nonexistent subsystem
            then:
    ...
    request {
        method 'POST'
        url "/subsystem-manager/v1/subsystems/${value(consumer('11'), producer('11'))}/connection-properties"
