...
Contract.make {
    ...
    request {
        method 'DELETE'
        url "/subsystem-manager/v1/subsystems/${value(consumer(anyPositiveInt()), producer('10'))}/connection-properties/${value(consumer('11'), producer('11'))}/subsystem-users/${value(consumer(anyPositiveInt()), producer('6'))}"
