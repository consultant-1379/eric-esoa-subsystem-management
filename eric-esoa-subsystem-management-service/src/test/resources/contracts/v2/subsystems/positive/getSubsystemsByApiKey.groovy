...
Contract.make {
    description(
            ...
            ```
            when:
                A client makes a request to get a specific subsystem by giving an api key
            then:
    ...
    request {
        method 'GET'
        url "/subsystem-manager/v2/subsystems/${value(consumer(anyNonEmptyString()), producer('0500c886-2b71-4d7d-be89-16fe7944cc67'))}"
        headers {
