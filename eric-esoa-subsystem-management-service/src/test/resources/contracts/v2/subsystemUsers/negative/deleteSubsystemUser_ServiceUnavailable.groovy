...
Contract.make {
    ...
    request {
        method 'DELETE'
        url "/subsystem-manager/v2/subsystems/${value(consumer('12'), producer('12'))}/connection-properties/${value(consumer(anyPositiveInt()), producer('4'))}/subsystem-users/${value(consumer(anyPositiveInt()), producer('6'))}"
